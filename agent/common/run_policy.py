"""Run type and policy definitions for the three-route system.

Routes:
  ordinary_game     – demo + review, no learning
  evaluation_batch  – benchmark + leaderboard, no learning
  evolution_training – the ONLY default learning source
  evolution_ab_baseline / evolution_ab_candidate – A/B validation only
"""
