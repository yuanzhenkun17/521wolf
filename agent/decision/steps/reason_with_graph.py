...
from agent.reasoning.graph import need_got, run_got_selection
from agent.core.context import AgentContext
from agent.infrastructure.llm import ModelAdapter


async def reason_with_graph_step(ctx: AgentContext, model: ModelAdapter, *, threshold: float = 0.3) -> AgentContext:
