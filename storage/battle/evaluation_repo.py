"""Evaluation repo: CRUD for player performance evaluations (battle database)."""
...
class EvaluationStore:
    ...
    def save_batch(
        ...
        Each dict must contain at least: id, game_id, player_seat, role.
        Optional keys: speech_score, vote_score, skill_score, information_score,
        cooperation_score, overall_score, created_at.
        """
        saved: list[str] = []
        now = self._timestamp()
