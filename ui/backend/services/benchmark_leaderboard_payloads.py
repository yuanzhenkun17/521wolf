...
def _leaderboard_row_payload(row: Any) -> dict[str, Any]:
    ...
    row_payload = {
        ...
        "score_sample_size": summary.get("score_sample_size"),
        "score_stddev": summary.get("role_score_stddev", summary.get("score_stddev")),
        "score_standard_error": summary.get(
            "role_score_standard_error",
            summary.get("score_standard_error"),
        ),
        "score_ci": summary.get("role_score_ci", summary.get("score_ci")),
        "valid_game_count": summary.get("valid_game_count"),
        "abnormal_game_count": summary.get("abnormal_game_count"),
