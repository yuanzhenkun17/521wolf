"""Persistence and recovery helpers for UI backend background tasks."""
...
class TaskPersistenceService:
    """Own PostgreSQL persistence, recovery, and replay state for background tasks."""
    ...
    def __init__(
        ...
        *,
        ...
        task_event_log: Callable[[], TaskEventLog],
    ) -> None:
        self._store = store
