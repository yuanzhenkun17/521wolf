...
<template>
  <section class="archive-review-panel">
    <template v-if="archiveData">
      <div class="archive-merged-strip">
        <span class="archive-merged-item archive-merged-winner">
          <small>胜方</small>
          <b>{{ displayWinnerLabel(archiveData.winner) }}</b>
        </span>
        <span class="archive-merged-item">
          <small>事件</small>
          <b>{{ archiveEventCount }}</b>
        </span>
        <span class="archive-merged-item">
          <small>决策</small>
...
.archive-merged-item small {
  color: rgba(74, 37, 15, 0.56);
  font-size: 12px;
  font-weight: 800;
}

.archive-merged-item b {
  color: var(--log-text);
  font-size: 14px;
  font-weight: 900;
...
.archive-merged-item b.archive-kpi-error {
  color: #c0392b;
}
