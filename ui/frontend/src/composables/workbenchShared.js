const ROLE_META = {
  white_wolf_king: { label: '白狼王', image: '/role-icons/白狼王.png' },
  werewolf: { label: '狼人', image: '/role-icons/普通狼.png' },
  villager: { label: '村民', image: '/role-icons/平民.png' },
  seer: { label: '预言家', image: '/role-icons/预言家.png' },
  witch: { label: '女巫', image: '/role-icons/女巫.png' },
  hunter: { label: '猎人', image: '/role-icons/猎人.png' },
  guard: { label: '守卫', image: '/role-icons/守卫.png' }
}
